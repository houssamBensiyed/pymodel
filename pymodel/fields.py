...
class Field:
    ...
    def __init__(
        self, primary_key=False, unique=False, nullable=False, default=None, column=None
    ):
...
class IntegerField(Field):
    def _validate_type(self, value):
        if not isinstance(value, int) or isinstance(value, bool):
            raise TypeError(
                f"Field '{self.name}' expects an int, got {type(value).__name__}"
            )
...
class StringField(Field):
    ...
    def _validate_type(self, value):
        if not isinstance(value, str):
            raise TypeError(
                f"Field '{self.name}' expects a str, got {type(value).__name__}"
            )
...
class BooleanField(Field):
    def _validate_type(self, value):
        if not isinstance(value, bool):
            raise TypeError(
                f"Field '{self.name}' expects a bool, got {type(value).__name__}"
            )
...
class DateTimeField(Field):
    def _validate_type(self, value):
        if not isinstance(value, datetime.datetime):
            raise TypeError(
                f"Field '{self.name}' expects datetime.datetime, got {type(value).__name__}"
            )
